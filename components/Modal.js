...
function Modale() {
  ...
  const handleConnection = () => {
    fetch("https://savetheseed-back.vercel.app/users/signin", {
      method: "POST",
    ...
    <div>
        ...
        <>
          <div>
            <Link href="/inscription">
              <Button className={styles.bttn1}>Inscription</Button>
            </Link>
          </div>
          <div>
      ...
      >
        ...
        <div className={styles.remember}>
          ...
          <p className={styles.forgottenPassword} href="">
            mot de passe oublié ?
          </p>
        </div>
